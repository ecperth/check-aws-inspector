...
var client = new client_ecr_1.ECRClient({ region: "ap-southeast-2" });
var command = new client_ecr_1.DescribeImageScanFindingsCommand({
...
var scan = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                err_1 = _a.sent();
                if (err_1 instanceof client_ecr_1.ScanNotFoundException) {
